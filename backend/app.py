from flask import Flask, render_template, request, jsonify, g, session, redirect, url_for, render_template_string
import sqlite3
import json
...
# -----------------------------
# AI PLACEHOLDER
# Replace this with Gemini logic later
# -----------------------------
def generate_ai_reply(user_message, form_data, conversation):
    ...
    return (
        ...
        "Note: This is a Flask placeholder reply. You can replace generate_ai_reply() with actual Gemini integration."
    )
...
def login_page():
    ...
    <body>
        <div class="login-box">
            ...
            <p class="sub">Sign in to access the loan telecaller system</p>
            ...
            <div class="note">Enter any username and password to continue</div>
        </div>
    </body>
    </html>
    """
...
def login_submit():
    ...
    return redirect(url_for("login_page", error="Please enter username and password"))
...
def lead_detail(lead_id):
    ...
    <div class="wrap">
        <div class="top-links">
            <p><a href="/leads">← Back to leads</a> | <a href="/logout">Logout</a></p>
        </div>
